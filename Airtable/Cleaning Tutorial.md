...
1.  Download the CSV from
     [transitionaljusticedata.com](https://transitionaljusticedata.com/)
...
4.  Identify the columns that might have filler data that needs to be
    ...
    a.  follow [this
         tutorial](https://tulane.box.com/s/y6bl2hev2et77dcsbe7gykydkybl10ot)
    ...
    b.  Once you find the values to replace, follow [this
         tutorial](https://tulane.box.com/s/lr6qofka2hidnxbd5z03zc6hylfh8vf2)
         to find and replace all of the filler values with blank cells

5.  Standardize dates by following [this
     tutorial](https://tulane.box.com/s/5h10nylyduu5000gt9b3jhj3kjc068v4)
...
7.  upload the clean data to the box folder
     [here](http://clean_trials_2021-03-13)
